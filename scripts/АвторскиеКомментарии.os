...
Процедура Выполнить(Параметры)
	...
	Лог.Отладка("Действие:" + Действие+ ":");
	
	Обмен.ЗаписатьРезультатВФайл("tmp\deb.log", "Д:" + Действие);
КонецПроцедуры
...
ФайлЖурнала.ОткрытьФайл("c:\work\portable\v8CfgAddsAhk\tmp\debug.log");
Лог.ДобавитьСпособВывода(ФайлЖурнала);
Лог.Отладка("Действие:ВОШЛИ:");
...
Обмен.ЗаписатьРезультатВФайл("c:\work\portable\v8CfgAddsAhk\tmp\deb.log", "0:" + АргументыКоманднойСтроки[0]);
