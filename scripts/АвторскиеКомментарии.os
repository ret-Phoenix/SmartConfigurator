...
Процедура ОбработкаТекста(Данные,Приемник,Действие)
	...
	ИначеЕсли Действие = "Изменено" Тогда
		...
		НовыеДанные = НовыеДанные
			...
			+ Символы.ВК + Символы.ПС
			+ "//" + ПолучитьСигантуру(Настройки.СигнатураКонец);
	ИначеЕсли Действие = "Удалено" Тогда
	...
	НовыеДанные = НовыеДанные  + Символы.ПС + Символы.ВК;
...
//     Лог = Логирование.ПолучитьЛог("v8cfgahkadds.module.module.authors");
