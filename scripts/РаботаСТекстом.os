...
Процедура ВыбратьШаблон() Экспорт
	...
	Для Каждого Стр Из МассивФайлов Цикл
		...
		Для Каждого Стр из Совпадения Цикл
			...
			СписокШаблонов.Вставить(Значение, Ключ);
...
Процедура ПриСозданииОбъекта()
	...
	Если Действие = "ВыбратьПрепроцессор" Тогда
		ВыбратьПрепроцессор();
	ИначеЕсли Действие = "ПродолжитьСтрокуКомментарий" Тогда
		ПродолжитьСтрокуКомментарий();
	ИначеЕсли Действие = "Инкремент" Тогда
		Инкремент(Параметры[1]);
	ИначеЕсли Действие = "ВыбратьШаблон" Тогда
		ВыбратьШаблон();
	Иначе
