...
//    http://infostart.ru/public/166814/  Автоформатирование кода
...
Процедура Форматировать( Знач Источник, Знач Приемник) Экспорт
	...
	ДокументТекст.Прочитать(Источник, КодировкаТекста.ANSI);
	...
	файлИзменен = Выравниватель.ВыровнитьКод( ДокументТекст ) ИЛИ файлИзменен;

	Если файлИзменен Тогда
		
		ДокументТекст.Записать(Приемник); 
