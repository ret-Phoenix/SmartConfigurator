...
Процедура Выполнить(Параметры)
    ...
    ФайлЖурнала.ОткрытьФайл("c:\Users\ushakov\Documents\portable\v8CfgAddsAhk\tmp\debug.log");
...
// МассивПарамеров.Добавить("НачалоМетода");
// МассивПарамеров.Добавить("c:\Users\ushakov\Documents\portable\v8CfgAddsAhk\tmp\module.txt");
