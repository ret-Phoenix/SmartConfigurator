...
Функция ЗапускПриложенияВзаимодействия(Приложение, Данные, Очищать=10, СписокВыбораВФайл="")
	// ФормаВыбораИзСписка(Данные, Очищать, СписокВыбораВФайл);
...
Функция ФормаВыбораИзСписка(Данные) Экспорт
	...
	// СписокВыбора.Вставить("Один", "1");
	// СписокВыбора.Вставить("Два", "2");
	// СписокВыбора.Вставить("Три", "3");
	ДанныеСписка = Данные;
...
Процедура ПриОткрытииФормы() Экспорт
	...
	// ПолеСписка.Значение = НовоеЗначение;
